...
function PostDetails() {
  ...
  const getBlog = async () => {
    await axios
      .get(`${process.env.NEXT_PUBLIC_BASE_URL}/blogs/getSingle/${blogId}`, {
        params: {
          id: blogId,
        },
      })
                ...
                <div className="post-meta">
                  <ul>
                    <li>
                      ...
                      {new Date(active?.blog?.createdAt).toLocaleDateString()}
                    </li>
                  </ul>
                </div>
              </div>
            ...
            <div className="row justify-content-center g-4">
              <div className="col-lg-8">
                ...
                >
                  <div
                    style={{ width: "100%" }}
                    dangerouslySetInnerHTML={{ __html: active?.blog?.content }}
                  ></div>
                </Box>
              </div>
            </div>
